    ...
    runtime.block_on(async {
        ...
        let builder = tauri::Builder::default()
            .setup(move |tauri_app| {
                ...
                if tauri_app.config().identifier != "com.gitbutler.app.test" {
            ...
            .invoke_handler(tauri::generate_handler![
                ...
                but_api::unity::tauri_unity_semantic_diff::unity_semantic_diff,
                but_api::unity::tauri_unity_smart_merge_preview::unity_smart_merge_preview,
                but_api::unity::tauri_run_unity_smart_merge::run_unity_smart_merge,
                ...
                legacy::repo::tauri_write_workspace_file::write_workspace_file,
                legacy::repo::tauri_list_local_ignored_paths::list_local_ignored_paths,
                legacy::repo::tauri_set_local_ignored_path::set_local_ignored_path,
                ...
                legacy::backups::tauri_get_backup_settings::get_backup_settings,
                legacy::backups::tauri_update_backup_settings::update_backup_settings,
                legacy::backups::tauri_create_backup::create_backup,
                legacy::backups::tauri_list_backups::list_backups,
                legacy::backups::tauri_delete_backup::delete_backup,
